...
import com.example.elasticserach.dao.PostRepository;
...
public class PostController {
    ...
    public Object matchQuery(String keyword){
        NativeSearchQuery build = new NativeSearchQueryBuilder().withQuery(QueryBuilders.matchQuery("content", keyword))
                .withSort(SortBuilders.scoreSort()).withPageable(
                        PageRequest.of(0,100, Sort.by(Direction.ASC,"userId"))).build();
        return elasticsearchTemplate.queryForList(build,Post.class);
    }
}
